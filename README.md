...
- **テキスト**（X）: 画像をクリックするとその場に入力欄が出ます。**Enterで確定、Shift+Enterで改行、Escで取り消し**。日本語入力（IME）も使えます。初期の文字色は赤（#E5484D）・24px、白い縁取りを付けて画像の上でも読めるようにしています。**置いた文字はテキストツール中にドラッグして移動**でき、移動もUndoできます。
